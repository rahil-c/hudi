...
import org.apache.spark.sql.execution.datasources.parquet.{ParquetFileFormat, Spark332PlusHoodieParquetFileFormat}
...
class Spark3_3Adapter extends BaseSpark3Adapter {
  ...
  override def createHoodieParquetFileFormat(appendPartitionValues: Boolean): Option[ParquetFileFormat] = {
    Some(new Spark332PlusHoodieParquetFileFormat(appendPartitionValues))
  }
